...
public class PushDBHandler {
    ...
    public boolean insertDeviceToken(JID targetJID, String token) {
        System.out.println("-----------insertDeviceToken--------insertDeviceToken");
    ...
    public boolean deleteDeviceToken(String token) {
        System.out.println("-----------deleteDeviceToken--------deleteDeviceToken");
    ...
    public String getDeviceToken(JID targetJID) {
        System.out.println("-----------getDeviceToken--------getDeviceToken");
    ...
    public List<String> getDeviceTokens(String roomName) {
        System.out.println("-----------getDeviceTokens--------getDeviceTokens");
